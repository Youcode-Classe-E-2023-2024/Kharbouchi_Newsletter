...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td style="padding-right: 0px;padding-left: 0px;" align="center">
      ...
      <img align="center" border="0" src="images/image-2.png" alt="Logo" title="Logo" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 18%;max-width: 104.4px;" width="104.4" class="v-src-width v-src-max-width"/>
      </a>
    </td>
  </tr>
</table>
...
<table id="u_content_heading_1" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  <tbody>
    ...
    <h1 class="v-font-size" style="margin: 0px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 31px; font-weight: 400;"><strong>New news</strong></h1>
...
<p style="font-size: 14px; line-height: 180%;"><br /><span style="font-size: 16px; line-height: 28.8px; font-family: Montserrat, sans-serif;">Dear [Title] [Last Name],

    We are thrilled to have you join our community! Thank you for subscribing and taking the time to explore our website.
    
    By subscribing, you've taken the first step towards staying updated with the latest news. We're committed to bringing you valuable and relevant information, and we hope you find our content both enriching and enjoyable.
    
    To complete your subscription process and ensure you don't miss out on any updates, please confirm your email by clicking the link below:
    
    [Confirmation Link]
    
    We believe in maintaining open lines of communication and value your feedback. Should you have any questions or need further information, please don't hesitate to contact us directly. Your satisfaction and engagement are our top priorities.
    
    We look forward to having you with us and hope you enjoy all that NewsLatter has to offer.
    
    Thank you once again for your interest and trust in us.
    
    Yours sincerely,.</a> </span></span></p>
  </div>
...
<div align="center">
    <a href="https://unlayer.com" target="_blank" class="v-button v-size-width v-font-size" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #ed8b03; border-radius: 22px;-webkit-border-radius: 22px; -moz-border-radius: 22px; width:48%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
      <span style="display:block;padding:23px 30px 22px;line-height:120%;"><strong><span style="font-size: 14px; line-height: 16.8px; font-family: Montserrat, sans-serif;">Confirm</span></strong></span>
    </a>
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-font-size" style="font-size: 14px; color: #6f7a7a; line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 12px; line-height: 16.8px; font-family: Montserrat, sans-serif;">© 2024 Company. All Rights Reserved.</span></p>
  </div>
